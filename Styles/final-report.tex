...
\author{%
  Akash Madiraju, Justin Chen, Prabhvir Singh, Tyler Xiao\thanks{Use footnote for providing further information
    about author (webpage, alternative address)---\emph{not} for acknowledging
    funding agencies.} \\
  University of California, Los Angeles\\
  Los Angeles, CA 90024 \\
  \texttt{akashm153@ucla.edu, justinc918@ucla.edu, prabab@ucla.edu, tylerxiao@ucla.edu}
}
