...
\begin{verbatim}
python -m emg2qwerty.train \
  user=single_user model=gru_ctc \
  trainer.accelerator=gpu \
  trainer.devices=1 \
...
\begin{verbatim}
python -m emg2qwerty.train \
  user=single_user model=hybrid_ctc \
  trainer.accelerator=gpu \
  trainer.devices=1 \
  trainer.max_epochs=1 \
  trainer.max_epochs=40
...
\begin{longtable}{rrrrrrrr}
	...
	40   & 128    & 2      & 0.0001 & 0.1     & 104.45  & 78.32    & 4.3515        \\
	41   & 128    & 2      & 0.0001 & 0.0     & 107.73  & 79.10    & 4.5090        \\
	42   & 128    & 2      & 0.0001 & 0.3     & 107.75  & 80.79    & 4.4906        \\
	43   & 128    & 2      & 0.0001 & 0.2     & 108.06  & 80.79    & 4.5392        \\
\end{longtable}
