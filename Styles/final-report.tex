...
\item {\bf Theory Assumptions and Proofs}
    ...
    \item[] Justification: The paper does not include theoretical mathematical results, we are only testing different model architectures and hyperparameters.
    \item[] Guidelines:
    \begin{itemize}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We provide architecture, code, data, and all hyperparameters used for the experiments.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Open access to data and code}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We provide a \href{https://github.com/lordboba/ece-c147a-final/}{GitHub repository} with the code and use open source data for the experiments.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Experimental Setting/Details}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We provide information on our train/test split along with an appendix containing all hyperparameter tuning runs. We also include architecture details and decisions in our paper too.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer NA means that the paper does not include experiments.
...
\item {\bf Experiment Statistical Significance}
    ...
    \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We do not include error bars in our paper, we are only testing different model architectures and hyperparameters. There is no statistical significance to test for.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer NA means that the paper does not include experiments.
...
\item {\bf Experiments Compute Resources}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We provide information on the GPU/computer resources used for the experiments in our paper. We also include the number of epochs and the size of our models in the paper.
    \item[] Guidelines:
    \begin{itemize}
        \item The answer NA means that the paper does not include experiments.
...
\item {\bf Code Of Ethics}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We adhere to the NeurIPS Code of Ethics and follow the guidelines provided by the conference.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Broader Impacts}
    ...
    \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: Our paper focuses on the performance of different model architectures on a dataset. While the research on this problem could have downstream impacts of producing real world applications, the focus of the paper is on researching the use of different neural network architectures and hyperparameters on a specific task.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Safeguards}
    ...
    \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: Our paper does not release any data or models that have a high risk for misuse.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf Licenses for existing assets}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We credit the original authors of the code and data we use in our paper. We also mention the license and terms of use explicitly in our paper. All information is available in our GitHub repository.
    \item[] Guidelines:
    \begin{itemize}
...
\item {\bf New Assets}
    ...
    \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
    \item[] Justification: We provide a detailed documentation of our dataset and code in our GitHub repository. We also include the license and terms of use explicitly in our paper. We also include new configurations and training sets that differentiate from existing ones.
    \item[] Guidelines:
    \begin{itemize}
